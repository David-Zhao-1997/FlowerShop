 ...
 */
!function (i) {
    "function" == typeof define && define.amd ? define("viewer", ["js/jQuery"], i) : i("object" == typeof exports ? require("js/jQuery") : jQuery)
}(function (i) {
    "use strict";
    ...
    var m = i(window), v = i(document), f = "viewer", g = document.createElement(f),
        w = "viewer-fixed", p = "viewer-open", b = "viewer-show", y = "viewer-hide",
        x = "viewer-hide-xs-down", $ = "viewer-hide-sm-down", C = "viewer-hide-md-down",
        z = "viewer-fade", F = "viewer-in", Y = "viewer-move", k = "viewer-active",
        I = "viewer-invisible", X = "viewer-transition", P = "viewer-fullscreen",
        T = "viewer-fullscreen-exit", V = "viewer-close", E = "img",
        ...
        q = "wheel mousewheel DOMMouseScroll", R = "transitionend", M = "load." + f,
        W = "keydown." + f, _ = "click." + f, j = "resize." + f, A = "build." + f, B = "built." + f,
        H = "show." + f, U = "shown." + f, N = "hide." + f, O = "hidden." + f, Z = "view." + f,
        K = "viewed." + f, Q = "undefined" != typeof g.style.transition, G = Math.round,
        J = Math.sqrt, ii = Math.abs, ti = Math.min, ei = Math.max, si = Number;
    u.prototype = {
        constructor: u, init: function () {
            var t = this.options, e = this.$element, s = e.is(E), n = s ? e : e.find(E),
                o = n.length, a = i.proxy(this.ready, this);
            ...
            var e = this.options, s = this.$image, n = this.viewer, o = this.$footer.height(),
                a = n.width, h = ei(n.height - o, o), r = this.image || {};
            ...
            var e = t.target, s = i(e), n = s.parent(), o = n.width(), a = n.height(),
            ...
            var t, e = this.options, s = i.originalEvent, n = s && s.touches, o = i,
                a = e.movable ? "move" : !1;
            if (this.isViewed)
            {
                if (n)
            ...
            var t, e = this.options, s = this.action, n = this.$image, o = i.originalEvent,
                a = o && o.touches, h = i;
            if (this.isViewed)
            {
                if (a)
            ...
            var o, a, h, r, l, c = this.options, u = .01, m = 100, v = this.image, f = v.width,
                g = v.height;
            ...
            var t, s = this.options, n = this.$player, o = i.proxy(this.loadImage, this), a = [],
                h = 0, r = 0;
